...
export default function Partnership() {
  ...
  const Icon = Handshake || Users || Globe
      ...
      <div className="max-w-5xl mx-auto px-6 pt-48 pb-32 relative min-h-[80vh] flex flex-col justify-center">
        ...
        >
          <div className="inline-flex items-center gap-3 mb-12">
            ...
            <span className="text-[10px] uppercase tracking-[0.6em] text-white/40 font-bold block italic">Collaboration</span>
          </div>
          
          <h1 className="text-7xl md:text-9xl font-serif font-light mb-12 leading-tight italic">
            AgriScore <span className="not-italic text-white/90">Partnerships</span>
          </h1>
          ...
          <div className="flex flex-col items-center gap-12">
            ...
            <div className="max-w-xl space-y-8">
              <div className="space-y-4">
                <span className="text-xs uppercase tracking-[0.4em] text-white/40 font-bold block tracking-[0.8em]">Ecosystem Scaling</span>
              ...
              <p className="text-white/40 text-sm md:text-base font-light tracking-wide leading-relaxed">
                We are curating an elite network of institutional partners, research labs, and AgTech innovators. The future of agricultural intelligence is collaborative, and our partner portal will be arriving shortly.
              </p>
            </div>
        ...
        <div className="mt-32 pt-12 border-t border-white/5 opacity-50">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-[9px] uppercase tracking-[0.4em] font-bold text-center md:text-left">
                <div>Institutional Framework</div>
                <div className="md:text-center italic">Expanding Global Footprint</div>
